...
angular.module('ate.monitor').config(['$routeProvider',
  function ($routeProvider) {
    $routeProvider
      ...
      .when('/admin/stations/edit/:ip_address', {
        templateUrl: '/static/partials/admin/admin_stations_edit.html',
      ...
      .when('/admin/product_config', {
        templateUrl: '/static/partials/admin/admin_product_config.html',
      ...
      .when('/admin/product_config/add', {
        templateUrl: '/static/partials/admin/admin_product_config_edit.html',
      ...
      .when('/monitor', {
        templateUrl: '/static/partials/monitor/monitor.html',
    ...
    .when('/barcode', {
        templateUrl: '/static/partials/barcode.html',
        controller: 'BarcodeController'
      })

     .when('/admin/server', {
        templateUrl: '/static/partials/admin/admin_server.html',
        controller: 'AdminServerController',
        resolve: {
                    factory: checkAdmin
                }
      })
      .when('/admin/server/add', {
        templateUrl: '/static/partials/admin/admin_server_edit.html',
        controller: 'AdminServerAddController',
        resolve: {
                    factory: checkAdmin
                }
      })
      .when('/admin/server/edit/:hostname', {
        templateUrl: '/static/partials/admin/admin_server_edit.html',
        controller: 'AdminServerEditController',
        resolve: {
                    factory: checkAdmin
                }
      })
     .when('/developer', {
        templateUrl: '/static/partials/developer.html',
