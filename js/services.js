...
//ServerAdmin service
.factory('ServerAdmin', ['$resource',
  function($resource) {
    return $resource('/admin/server',{},
      {update: {method: 'PUT'}}
    );
  }
])
...
.factory('DevStation', ['$resource',
  function($resource) {
    return $resource('/dev/station',{},
      {update: {method: 'PUT'}}
    );
  }
])
...
.factory('ProductConfig', ['$resource',
  function($resource) {
    return $resource('/admin/product_conf',{},
      {update: {method: 'PUT'}}
    );
  }
])
...
.factory('MonitorUser', ['$resource',
  function($resource) {
    return $resource('/monitor/user',{},
      {update: {method: 'PUT'}}
    );
  }
])

.factory('BatchValidate', ['$resource',
  function($resource) {
    return $resource('/api/batch/validate',{},
      {update: {method: 'PUT'}}
    );
  }
])

.factory('MonitorStation', ['$resource',
  function($resource) {
    return $resource('/monitor/station',{},
      {update: {method: 'PUT'}}
    );
  }
])
.factory('MonitorFixture', ['$resource',
  function($resource) {
    return $resource('/monitor/fixture',{},
      {update: {method: 'PUT'}}
    );
  }
])
.factory('MonitorServer', ['$resource',
  function($resource) {
    return $resource('/monitor/server',{},
      {update: {method: 'PUT'}}
    );
  }
]);
