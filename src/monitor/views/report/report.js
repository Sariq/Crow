(function () {
    ...
    function ReportController($scope, $filter, $resource, ngTableParams) {
        ...
        $scope.ReportResource = $resource('/monitor/api/report', {},
    ...
    angular.module('ate.monitor')
        .controller('ReportController', ['$scope', '$filter', '$resource', 'ngTableParams', ReportController]);
}());
