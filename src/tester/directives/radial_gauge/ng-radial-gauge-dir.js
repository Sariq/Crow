...
*/
 ...
 angular.module('ate.tester').directive('ngRadialGauge', ['$window', '$timeout', 'd3Service',
             ...
             d3Service.d3().then(function (d3) {
                 ...
                 var getMajorGraduationValues = function (minLimit, maxLimit) {
                     ...
                     for (var i = 0; i <= majorGraduations; i++) {
                         ...
                         majorGraduationValues.push((scope.precision));
                     }
                 ...
                 var renderMajorGraduationTexts = function (majorGraduationsAngles, majorGraduationValues) {
                     ...
                     var textSize = isNaN(majorGraduationTextSize) ? (width * 0) / 300 : majorGraduationTextSize;
                 ...
                 var renderGraduationNeedle = function (minLimit, maxLimit) {
                     ...
                     if (typeof scope.value === 'undefined') {
                         ...
                         var textSize = isNaN(needleValueTextSize) ? (width * 60) / 300 : needleValueTextSize;
                         var fontStyle = textSize + "px Courier";
                         ...
                         svg.append("text")
                             .attr("x", centerX)
                             .attr("y", centerY + valueVerticalOffset+5)
                             .attr("class", "mtt-graduationValueText")
                             .attr("fill", needleColor)
                             .attr("text-anchor", "middle")
                             .attr("font-weight", "bold")
                             .style("font", fontStyle)
                             .text( (scope.precision) + scope.valueUnit );
                     }
                     ...
                     renderTimeout = $timeout(function () {
                         ...
                         if (typeof scope.ranges === 'undefined') {
                             ...
                             //Data Generation
                                 ...
                                 {
                                     d3DataSource.push([scope.ranges[i].min, scope.ranges[i].max, scope.ranges[i].color]);
                                 }
